...
class RepairSubSharesTest extends TestCase {
	...
	public function testPopulateDBAndRemoveDuplicates() {
		...
		$userArray = [
			['share_with' => 'user1', 'parent' => '1'],
			['share_with' => 'user1', 'parent' => '2'],
			['share_with' => 'user2', 'parent' => '2'],
			['share_with' => 'user2', 'parent' => '3'],
			['share_with' => 'user3', 'parent' => '4'],
			['share_with' => 'user3', 'parent' => '5'],
			['share_with' => 'user4', 'parent' => '5'],
		];
		foreach ($userArray as $sharewith) {
			$this->assertTrue(\in_array($sharewith, $results));
		}
	...
	public function testLargeDuplicateShareRows() {
		...
		$userArray = [
			['share_with' => 'user1', 'parent' => '1'],
			['share_with' => 'user2', 'parent' => '2'],
			['share_with' => 'user3', 'parent' => '3'],
			['share_with' => 'user4', 'parent' => '4'],
			['share_with' => 'user5', 'parent' => '5'],
			['share_with' => 'user6', 'parent' => '6'],
		];
		foreach ($userArray as $sharewith) {
			$this->assertTrue(\in_array($sharewith, $results));
		}
